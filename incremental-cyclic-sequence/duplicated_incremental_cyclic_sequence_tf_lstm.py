...
data: list[int] = []
for _ in range(0, data_size, sequence_size * 2):
...
predict_number([1, 1, 2, 2, 3], 3)
predict_number([1, 2, 2, 3, 3], 4)
predict_number([2, 2, 3, 3, 4], 4)
predict_number([2, 3, 3, 4, 4], 5)
predict_number([3, 3, 4, 4, 5], 5)
predict_number([3, 4, 4, 5, 5], 1)
predict_number([4, 4, 5, 5, 1], 1)
predict_number([4, 5, 5, 1, 1], 2)
predict_number([5, 5, 1, 1, 2], 2)
predict_number([5, 1, 1, 2, 2], 3)
