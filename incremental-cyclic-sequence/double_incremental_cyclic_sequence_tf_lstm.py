...
for _ in range(0, data_size, sequence_size):
    for j in range(0, sequence_size):
        data.append(j * increment_factor)
...
predict_number([0, 2, 4, 6, 8], 0)
predict_number([2, 4, 6, 8, 0], 2)
predict_number([4, 6, 8, 0, 2], 4)
predict_number([6, 8, 0, 2, 4], 6)
predict_number([8, 0, 2, 4, 6], 8)
